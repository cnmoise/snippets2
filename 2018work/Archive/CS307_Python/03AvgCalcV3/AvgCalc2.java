...
// 			System.out.println("Score for Academic Record: " + calcAcademicRecord(RoundedGPA));
         ...
         System.out.println("Is the student a freshman? (y/n)");
   		kbw = kb.next();
         ...
         if(kbw.equals("y")) {
   			...
   			System.out.println("Invalid entry... Assuming student is a NON-Freshman");
   		}
         ...
         if(isFreshman){
            ...
            RoundedGPA = (double)calculateRoundedGPA(ColGPA, HighGPA, weighted);
            System.out.println("Student Name: " + studentName);
            System.out.println("RoundedGPA: " + RoundedGPA);
         }
         else{
            System.out.println("Please enter the NON-Freshman students College GPA:");
      		ColGPA = kb.nextDouble();
            RoundedGPA = ColGPA;
            System.out.println("RoundedGPA: " + RoundedGPA);
         }
         ...
         //Do we want a failure state if # entered is less than 3.5?
