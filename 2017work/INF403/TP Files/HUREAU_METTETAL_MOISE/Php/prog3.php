...
if(isset($_GET['mois'])){
    ...
    try{
        ...
        $firstDay = DateTime::createFromFormat(GET_DATE_FORMAT,$_GET['mois']);//si la donnée est au mauvais format, une exception est lancée
...
<!--
	<form action="programmation_action.php" method="post">
