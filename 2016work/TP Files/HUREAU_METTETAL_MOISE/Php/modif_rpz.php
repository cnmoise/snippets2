<?php
	$titre = 'Modifier une Representations';
	...
	else 
	{
		...
		if (!$res) {
			...
			echo ("
				<form action=\"modif_rpz_action.php\" method=\"post\">
					<label for=\"sel_noSpec\">Sélectionnez un spectacle à modifier :</label>
			...
			do {
				...
				$dateRep = oci_result($curseur, 3);
				echo ("<option value=\"$numSpec\">$numSpec $nomSpec $dateRep</option>");
				$_SESSION("")
...
?>
		...
		<label for="date">Sélectionnez une nouvelle date :</label>
		<input type="date" name="date" id="date"/>
		<br /><br />
		<label for="time">Sélectionnez une nouvelle heure :</label>
