<?php
	...
	//titre
	$titre = "Liste des places associées au dossier n°".$_SESSION['dossier']." pour la catégorie $categorie";
	$previous_page = "SpectaclesDossier_v3_2.php";
	...
	oci_bind_by_name($curseur, ':o', $_SESSION['dossier']);
