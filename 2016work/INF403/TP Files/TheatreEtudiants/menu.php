...
<h1>Bienvenue dans l’application Théâtre !</h1>
      ...
      <ul class="menu">
<li><a href="GererReservations.php">Gérer les réservations</a> <br>
<a href="scenarioReserver.php">Voir le scénario 'reserver'</a>
<a href="scenarioSupprimer.php">Voir le scénario 'supprimer'</a></li>
<li><a href="GererRepresentations.php">Gérer les représentations</a> <br>
<a href="scenarioProgrammer.php">Voir le scénario 'programmer'</a> </li>
      </ul>
